...
const mainItems = [
  ...
  { id: 'templates', title: 'Power BI Templates', path: ROUTES.ADMIN.TEMPLATES, icon: <DescriptionIcon /> },
  { id: 'html-templates', title: 'Interactive Report Templates', path: ROUTES.ADMIN.HTML_TEMPLATES, icon: <HtmlTemplateIcon /> },
  ...
  { id: 'credit-purchase-requests', title: 'Credit Purchases', path: ROUTES.ADMIN.CREDIT_PURCHASE_REQUESTS, icon: <CreditPurchaseIcon /> },
